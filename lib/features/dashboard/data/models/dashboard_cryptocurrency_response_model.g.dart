...
part of 'dashboard_cryptocurrency_response_model.dart';
...
DashboardCryptocurrencyModel _$DashboardCryptocurrencyModelFromJson(
  ...
  quote: (json['quote'] as Map<String, dynamic>?)?.map(
    (k, e) =>
        MapEntry(k, DashboardCurrencyModel.fromJson(e as Map<String, dynamic>)),
  ),
);

Map<String, dynamic> _$DashboardCryptocurrencyModelToJson(
  DashboardCryptocurrencyModel instance,
) => <String, dynamic>{
  'id': instance.id,
  'name': instance.name,
...
DashboardCurrencyModel _$DashboardCurrencyModelFromJson(
  Map<String, dynamic> json,
...
Map<String, dynamic> _$DashboardCurrencyModelToJson(
  DashboardCurrencyModel instance,
) => <String, dynamic>{
