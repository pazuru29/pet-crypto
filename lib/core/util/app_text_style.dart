...
enum AppTextStyle {
  ...
  titleRegular(TextStyle(fontSize: 24, fontWeight: .normal)),
  ...
  titleSemibold(TextStyle(fontSize: 24, fontWeight: .w600)),
  ...
  titleBold(TextStyle(fontSize: 24, fontWeight: .bold));
